...
<section>
    ...
    <section class="panel">
                    ...
                    <div class="serachDate">
                        <div class="col-md-4">
                            <div class="input-group input-large custom-date-range">
                                ...
                                <input type="text" class="searchInput" id="dateStart" value="<?php echo ($result['startDate']); ?>">
                                <span class="input-group-addon">To</span>
                                <input type="text" class="searchInput" id="dateEnd" value="<?php echo ($result['endDate']); ?>">
                            </div>
                        </div>
                    </div>
                    <div class="btn-group">
        ...
        <div class="dataAll">
            <button class="btn btn-info btn-xs" type="button"><i class="fa fa-plus-square-o"></i> 增加渠道/经纪人</button>
