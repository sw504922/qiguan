...
<section>
    ...
    <ul class="breadcrumb panel headTop">
        <li><i class="fa fa-list"></i> 入金管理</li>
    </ul>
    ...
    <section class="panel divBox">
        <header class="panel-heading">
            <div class="selectArea">
                    ...
                    <div id="widthEight" style="display: none;margin-top: 20px"></div>
                    <div class="btn-group" id="channelAllButton">
                    ...
                    <div class="btn-group" id="tradeButtonSub">
